[![Build Status](https://travis-ci.org/trainerbill/PayPalPaymentsProClassicLite.png?branch=master)](https://travis-ci.org/trainerbill/PayPalPaymentsProClassicLite)
