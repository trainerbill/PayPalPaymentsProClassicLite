...
$variables = array(
	'RETURNURL' => 'http://'.$_SERVER['HTTP_HOST'].preg_replace('/recurringpayments\/setec.php/','getexpresscheckout.php',$_SERVER['SCRIPT_NAME']),
	'CANCELURL' => 'http://'.$_SERVER['HTTP_HOST'].preg_replace('/recurringpayments\/setec.php/','cancel.php',$_SERVER['SCRIPT_NAME']),
	'PAYMENTREQUEST_0_AMT' => '100.00',
	'PAYMENTREQUEST_0_CURRENCYCODE' => 'USD',
	'PAYMENTREQUEST_0_PAYMENTACTION' => 'Sale',  //Valid values are Sale,Authorization,Order
	
	//Create Billing Agreement and recurring payment profile
